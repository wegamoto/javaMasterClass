...
public class Contact {
    ...
    public Contact mergeContactData(Contact conntact) {

        Contact newContact = new Contact(name);
        newContact.emails = new HashSet<>(this.emails);
        newContact.phones = new HashSet<>(this.phones);
        newContact.emails.addAll(newContact.emails);
        newContact.phones.addAll(newContact.phones);
        return newContact;
    }
    ...
    public void addEmail(String companyName) {
        ...
        if (!emails.add(email)) {
            ...
            System.out.println(name + " new has email " + email);
        }
    }

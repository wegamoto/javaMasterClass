...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Create a genric class to implement a league table for a sport.
        // The class should allow teams to be added to the list, and store
        // a list of teams that belong to the leage.
        //
        ...
        footballLeague.add(adeladieCrows);
...
//        footballLeague.add(baseballTeam);
        ...
        rawLeague.add(adeladieCrows); // no warning
        rawLeague.add(baseballTeam); // no warning
        rawLeague.add(rawTeam); // no warning

        League reallyRaw = new League("Really raw");
        reallyRaw.add(adeladieCrows); // unchecked warning
